...
Apply migrations through `e20300000001`. The transaction/value reset is available only with `ENVIRONMENT=uat` and `ALLOW_DATA_RESET=true`; production rejects it unconditionally.
