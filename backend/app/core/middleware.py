...
class RequestContextMiddleware(BaseHTTPMiddleware):
    ...
    async def dispatch(self, request: Request, call_next) -> Response:
        ...
        # A route may intentionally return a stricter policy (for example file
        # downloads use ``default-src 'none'``).  Do not weaken it by replacing
        # it with the application-shell policy here.
