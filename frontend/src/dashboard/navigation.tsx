...
export const navItems: NavItem[] = [
  ...
  { key: 'openingBalances', ar: 'الأرصدة الافتتاحية للنظام', en: 'System Opening Balances', icon: FileCheck2, scope: allScopes, group: 'finance', requires: ['finance.opening'] },
  { key: 'vatReturn', ar: 'إقرار ضريبة القيمة المضافة', en: 'VAT Return', icon: FileCheck2, scope: allScopes, group: 'tax', requires: ['compliance'] },
  ...
  { key: 'items', ar: 'تكويد الأصناف والتصنيفات', en: 'Item Coding & Categories', icon: Package, scope: allScopes, requires: ['inventory'], group: 'procurement' },
  ...
  { key: 'salesReturns', ar: 'مرتجعات المبيعات', en: 'Sales Returns', icon: RotateCcw, scope: allScopes, requires: ['subledgers'], group: 'sales' },
  { key: 'purchases', ar: 'المشتريات', en: 'Purchases', icon: ShoppingCart, scope: allScopes, group: 'procurement', requires: ['subledgers'] },
  { key: 'purchaseReturns', ar: 'مرتجعات المشتريات', en: 'Purchase Returns', icon: RotateCcw, scope: allScopes, requires: ['subledgers'], group: 'procurement' },
