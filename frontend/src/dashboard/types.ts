...
export type View =
  | 'executive' | 'core' | 'finance' | 'aging' | 'returns' | 'salesReturns' | 'purchaseReturns' | 'openingBalances' | 'withholdingTax' | 'exciseTax' | 'zakatIncomeTax' | 'budget' | 'transactions' | 'inventory' | 'inventoryTraceability' | 'operationalControls'
