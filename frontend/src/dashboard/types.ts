...
export type View =
  ...
  | 'sales' | 'purchases' | 'maintenance' | 'fleet' | 'legal' | 'users' | 'items' | 'dataReset' | 'chartOfAccounts' | 'manualJournals' | 'openingBalances' | 'cipProjects' | 'reports' | 'crm' | 'treasury' | 'leases' | 'assets' | 'prepaids' | 'accruals'
